...
import $ from 'jquery'
import PlayerGames from './PlayerGames.jsx'
...
class LobbyBase extends React.Component{
    ...
    getPlayerGames(){
        this.serverRequest = $.get('http://localhost:8080/api/player-games/?format=json', function (result) {
            this.setState({
    ...
    render(){
        return(
            <div className="row">
                <Websocket
                    ref="socket"
                    url={this.props.socket}
                    onMessage={this.handleData.bind(this)}
                    reconnect={true}
                />
                <div className="col-lg-4">
                    <PlayerGames
                        player={this.props.current_user}
                        game_list={this.state.player_game_list}
